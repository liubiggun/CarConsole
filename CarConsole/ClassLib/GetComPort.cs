...
namespace CarConsole.ClassLib
{
    ...
    class GetComPort
    {
        ...
        //通过WMI获取COM端口
        public static string[] ComPorts = GetComPort.MulGetHardwareInfo(GetComPort.HardwareEnum.Win32_PnPEntity, "Name");
        ...
        public static List<string> GetComList()
        {
            ...
            {
                str.Add((string)keyCom.GetValue(sSubKeys[i]));
            }
            return str;
        }
        ...
        {
            List<string> ExistPorts = new List<string>();
            ...
            //获取当前子健
            String[] str = sitekey.GetValueNames();
            ...
            {
                ExistPorts.Add(sitekey.GetValue(str[i]).ToString());
            }
            return ExistPorts;
        }
    }
